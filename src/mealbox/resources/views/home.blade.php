...
@section('content')
  <main role="main">
  <section class="jumbotron text-center mt-5 pb-md-5 pb-2 mb-0" style="background-image: url('{{ asset('title-image.jpg') }}'); background-size: cover; background-color:rgba(255,255,255,0.4); background-blend-mode:lighten; border-radius: 0;">
