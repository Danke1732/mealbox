...
@csrf
  ...
  <button class="btn btn-lg shadow-sm btn-primary btn-block mb-2" type="submit">ログイン</button>
  <a href="/" class="btn btn-lg shadow-sm btn-success btn-block">トップ画面に戻る</a>
</form>
@endsection